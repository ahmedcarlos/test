...
import 'package:flutter_app/note_detail.dart';
...
updateListView();
    ...
    return new MaterialApp(
      ...
      home: Scaffold(
          appBar: AppBar(
            leading: IconButton(
              ...
              onPressed: () {Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) => MyText(),));
              },
            ),
            title: Text("Notes"),
            elevation: 0.0,
      ...
      tooltip: "this button to add new Note",
    ),
      ),
    );
  }
...
navigateToDetail(this.noteList[position], 'Edit Note');
  ...
  Icon getPriorityIcon(int priority){
    switch(priority){
      ...
      case 2 :
        return Icon(Icons.keyboard_arrow_right);break;
      default:
